...
export const games = [
    ...
    },
    {
        ...
        category: 'lançamento',
        price: 699.99,
        description: 'Jason e Lucia sempre souberam que tudo estava contra eles. Mas, depois que um serviço simples dá errado, eles vão parar no lado mais sombrio do lugar mais ensolarado dos Estados Unidos, em meio a uma conspiração criminosa se estendendo por todo o estado de Leonida sendo forçados a depender um do outro mais do que nunca para saírem dessa vivos.',
        plataforma: ['Xbox', 'PlayStation'],
